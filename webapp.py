...
# ASK HOW TO PREVENT SQL INJECTIONS ~ ?, already done
# EXPLORE THE DIFFERENCE BETWEEN GET AND POST DATA ~ will do
# DON'T NEED TO SPECIFY THAT URL EXPLICITLY?? ~ okay
# HOW TO ORGANIZE HTML -- I HAS LOTS OF HTML FILES THAT ARE SIMILAR. DAT SIDE MENU. ~ go to next exercise to find out!
# LINKS
# PRETTINESS
